                        ...
                        <form method="POST" action="{{ route('domains.store') }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 bg-white/60 border border-[#F2059F]/15 rounded-2xl p-6 shadow-inner shadow-white/40">
                                <div class="md:col-span-2">
                                    ...
                                    <x-text-input id="domain_name" class="block mt-1 w-full bg-white border-gray-200 text-gray-900 placeholder-gray-400 focus:border-vc-magenta focus:ring-vc-magenta rounded-xl" type="text" name="domain_name" :value="old('domain_name')" placeholder="ejemplo.com" required />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="registration_date" class="block mt-1 w-full bg-white border-gray-200 text-gray-900 focus:border-vc-magenta focus:ring-vc-magenta rounded-xl" type="date" name="registration_date" :value="old('registration_date', date('Y-m-d'))" required />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="expiration_date" class="block mt-1 w-full bg-white border-gray-200 text-gray-900 focus:border-vc-magenta focus:ring-vc-magenta rounded-xl" type="date" name="expiration_date" :value="old('expiration_date', date('Y-m-d', strtotime('+1 year')))" required />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="price" class="block mt-1 w-full bg-white border-gray-200 text-gray-900 placeholder-gray-400 focus:border-vc-magenta focus:ring-vc-magenta rounded-xl" type="number" name="price" :value="old('price', '0.00')" step="0.01" min="0" required />
                                ...
                                <div>
                                    ...
                                    <select id="status" name="status" class="block mt-1 w-full bg-white border-gray-200 text-gray-900 focus:border-vc-magenta focus:ring-vc-magenta rounded-xl shadow-sm" required>
                                        ...
                                        <option value="expirado" {{ old('status') === 'expirado' ? 'selected' : '' }}>Expirado</option>
                                    </select>
                                ...
                                <div class="md:col-span-2">
                                    <label class="inline-flex items-center cursor-pointer">
                                        <input type="checkbox" name="auto_renew" value="1" {{ old('auto_renew') ? 'checked' : '' }} class="rounded border-gray-300 text-vc-magenta shadow-sm focus:ring-vc-magenta">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="hosting_info" name="hosting_info" rows="2" class="block mt-1 w-full bg-white border-gray-200 text-gray-900 placeholder-gray-400 focus:border-vc-magenta focus:ring-vc-magenta rounded-xl shadow-sm" placeholder="Proveedor de hosting, plan, etc.">{{ old('hosting_info') }}</textarea>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="dns_servers" name="dns_servers" rows="2" class="block mt-1 w-full bg-white border-gray-200 text-gray-900 placeholder-gray-400 focus:border-vc-magenta focus:ring-vc-magenta rounded-xl shadow-sm" placeholder="ns1.example.com, ns2.example.com">{{ old('dns_servers') }}</textarea>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="plugins" name="plugins" rows="2" class="block mt-1 w-full bg-white border-gray-200 text-gray-900 placeholder-gray-400 focus:border-vc-magenta focus:ring-vc-magenta rounded-xl shadow-sm" placeholder="WooCommerce, Elementor, Yoast SEO, etc.">{{ old('plugins') }}</textarea>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="licenses" name="licenses" rows="2" class="block mt-1 w-full bg-white border-gray-200 text-gray-900 placeholder-gray-400 focus:border-vc-magenta focus:ring-vc-magenta rounded-xl shadow-sm" placeholder="Antivirus activo, SSL activo, Premium activa, etc.">{{ old('licenses') }}</textarea>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="notes" name="notes" rows="3" class="block mt-1 w-full bg-white border-gray-200 text-gray-900 placeholder-gray-400 focus:border-vc-magenta focus:ring-vc-magenta rounded-xl shadow-sm" placeholder="Notas adicionales sobre este dominio...">{{ old('notes') }}</textarea>
