...
<body>
    ...
    <style>
        body { 
            ...
            zoom: 0.6; /* Use zoom for better layout scaling */
        } 
        .page { 
    ...
    <div id="vc-preview-document">
        ...
        <div class="page page--extra">
            <img class="page--extra__image" src="{{ asset('images/' . $image) }}" alt="Detalle del servicio">
            ...
            <div class="vc-modal-body">
                <form id="email-form">
                    <div class="vc-input-group">
                        ...
                        <input type="email" id="email-address" name="email" placeholder="ejemplo@empresa.com" required value="{{ $quotation->client_email }}">
                    </div>
    ...
    <div id="vc-success-modal" class="vc-success-modal">
        <div class="vc-success-content">
            ...
            <button onclick="document.getElementById('vc-success-modal').style.display='none'" class="vc-btn-primary" style="width: 100%; justify-content: center;">
                Aceptar
            </button>
        </div>
    </div>
    ...
    <script>
        (function () {
            ...
            // Inject Settings
            window.vcSettings = @json($settings);
